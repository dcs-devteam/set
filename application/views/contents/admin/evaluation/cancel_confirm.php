<div id="delete-confirm-container" class="panel panel-danger confirm-container">
	...
	<div class="panel-body">
		<div id="message-content">
			<p>Are you sure you want to cancel evaluation for class <?php echo $class_name?>?</p>
	...
	<div class="panel-footer">
		<?php echo form_open('admin/evaluation/cancel/'.$class_id, array('id' => 'delete-confirm-form'));?>
