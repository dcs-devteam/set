								...
								<div class="comments">
									...
									<ol class="contents">
										<li class="strong_points">
											...
											<span><?php echo $class->report['evaluations'][$e_index]->strong_points?>&nbsp;</span>
										</li>
										<li class="weak_points">
											<label><strong><?php echo $class->report['questions']['3']['content']['2']?></strong></label>
											<span><?php echo $class->report['evaluations'][$e_index]->weak_points?>&nbsp;</span>
										</li>
										<li class="recommendations">
											<label><strong><?php echo $class->report['questions']['3']['content']['3']?></strong></label>
											<span><?php echo $class->report['evaluations'][$e_index]->recommendations?>&nbsp;</span>
										</li>
									</ol>
								</div>
							</div>
							...
							<div class="content">
								...
								<div class="comments">
									...
									<ol class="contents">
										<li class="strong_points">
											<label><strong><?php echo $class->report['questions']['3']['content']['1']?></strong></label>
											<span><?php echo $class->report['evaluations'][$e_index+1]->strong_points?>&nbsp;</span>
										</li>
										<li class="weak_points">
											<label><strong><?php echo $class->report['questions']['3']['content']['2']?></strong></label>
											<span><?php echo $class->report['evaluations'][$e_index+1]->weak_points?>&nbsp;</span>
										</li>
										<li class="recommendations">
											<label><strong><?php echo $class->report['questions']['3']['content']['3']?></strong></label>
											<span><?php echo $class->report['evaluations'][$e_index+1]->recommendations?>&nbsp;</span>
										</li>
									</ol>
								</div>
							</div>
