		...
		<tbody>
			<?php foreach ($classes as $class):?>
				<tr>
					...
					<td>
						<span class="badge"><?php if($class->number_of_students > 0) $temp = $class->submissions/$class->number_of_students; else $temp = 0; echo str_pad(format_percent($temp, 0), 3, '0', STR_PAD_LEFT); ?></span>
