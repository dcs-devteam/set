...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2015 at 01:29 PM
...
-- Database: `upcdcs_set`
--
CREATE DATABASE IF NOT EXISTS `upcdcs_set` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `upcdcs_set`;
...
ALTER TABLE `class`
  ...
  ADD UNIQUE KEY `unique_class` (`year`,`semester`,`course_id`,`section`),
...
--
ALTER TABLE `office`
  ADD CONSTRAINT `office_ibfk_1` FOREIGN KEY (`chair_id`) REFERENCES `teacher` (`teacher_id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- Events
--
CREATE DEFINER=`upcdcs_paul`@`localhost` EVENT `update_year_sem` ON SCHEDULE EVERY 1 HOUR STARTS '2014-11-09 18:13:43' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN 
